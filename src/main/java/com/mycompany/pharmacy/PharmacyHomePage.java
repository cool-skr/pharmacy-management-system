...
public class PharmacyHomePage extends javax.swing.JFrame {
     ...
     * 
     */
    public PharmacyHomePage(String id, String name) {
        this.pharma_id=id;
        this.pharma_name = name;
        initComponents();
        jPanel3.setVisible(false);
        setPharmacyDetails(id);
        populateDistributors();
        proceed.setVisible(false);
    }
    
    private void setPharmacyDetails(String id){
        ...
        try{
            ...
            if(!rs.isBeforeFirst()){
                ...
                while(rs.next()){
                    pharmaNameField.setText(rs.getString("name"));
                    pharmaAddressField.setText(rs.getString("address"));
                    pharmaPinField.setText(rs.getString("pin"));
                    pharmaContactField.setText(rs.getString("contact"));
                    pharmaPassField.setText(rs.getString("password"));
                    this.pharma_name=pharmaNameField.getText();
    ...
    private void populateDistributors() {
        ...
        try{
            ...
            ResultSet rs = ps.executeQuery();
            if(!rs.isBeforeFirst()){
                JOptionPane.showMessageDialog(this, "No distributors avaialble");
    ...
    private void initComponents() {
        ...
        pharmaAddressField = new javax.swing.JTextField();
        pharmaNameField = new javax.swing.JTextField();
        pharmaContactField = new javax.swing.JTextField();
        pharmaPinField = new javax.swing.JTextField();
        pharmaPassField = new javax.swing.JPasswordField();
        ...
        viewInventoryButton.setBackground(new java.awt.Color(0, 0, 0));
        viewInventoryButton.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        viewBillsButton.setMaximumSize(new java.awt.Dimension(99, 27));
        viewBillsButton.setMinimumSize(new java.awt.Dimension(99, 27));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(viewInventoryButton, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addComponent(viewBillsButton, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(43, 43, 43)
                .addComponent(placeOrderButton, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(58, 58, 58)
                .addComponent(viewInventoryButton, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        pharmaAddressField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pharmaAddressFieldActionPerformed(evt);
            }
        });

        pharmaPinField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pharmaPinFieldActionPerformed(evt);
            }
        });
        ...
        card2Layout.setHorizontalGroup(
            ...
            .addGroup(card2Layout.createSequentialGroup()
                ...
                .addGroup(card2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(card2Layout.createSequentialGroup()
                        .addComponent(pharmaNameField, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 129, Short.MAX_VALUE)
                        .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addGroup(card2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(update, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(pharmaPassField, javax.swing.GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE))
                        .addGap(48, 48, 48))
                    .addGroup(card2Layout.createSequentialGroup()
                        .addGroup(card2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(pharmaPinField, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(pharmaAddressField, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(pharmaContactField, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
        card2Layout.setVerticalGroup(
            ...
            .addGroup(card2Layout.createSequentialGroup()
                ...
                .addGroup(card2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(pharmaPassField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(pharmaNameField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(44, 44, 44)
                .addGroup(card2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(pharmaAddressField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(44, 44, 44)
                .addGroup(card2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel8)
                    .addComponent(pharmaPinField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 62, Short.MAX_VALUE)
                .addGroup(card2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(pharmaContactField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(25, 25, 25)
                .addComponent(update)
                .addGap(77, 77, 77))
        );
    ...
    private void orderButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_orderButtonActionPerformed
        // TODO add your handling code here:
        chosenDistributor = String.valueOf(comboBox.getSelectedIndex()+1);
        String query = "SELECT drug_id FROM Distributor_Inventory where distributor_id=" + chosenDistributor;
        ...
        //drugid.setText(chosenDistributor);
    ...
    private void additemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_additemActionPerformed
        ...
        String query = "SELECT *  FROM Distributor_Inventory where distributor_id="+chosenDistributor+" and drug_id="+drug;
    ...
    private void proceedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proceedActionPerformed
        // TODO add your handling code here:
        PharmacyBill pb = new PharmacyBill(chosenDistributor,newbill, pharma_id ,pharma_name ,comboBox.getSelectedItem().toString());
        pb.setVisible(true);
    ...
    private void pharmaAddressFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pharmaAddressFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_pharmaAddressFieldActionPerformed

    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        // TODO add your handling code here:
        try{
            String query ="update pharmacy set name=?, address=?, pin=?, contact=?, password=? where pharma_id=?";
            PreparedStatement ps =con.prepareStatement(query);
            ps.setString(1, pharmaNameField.getText());
            ps.setString(2, pharmaAddressField.getText());
            ps.setString(3, pharmaPinField.getText());
            ps.setString(4, pharmaContactField.getText());
            char[] passwordArray = pharmaPassField.getPassword();
            String pwd = new String(passwordArray);
            ps.setString(5, pwd);
            ps.setString(6, pharma_id);
            ps.execute();
    ...
    private void viewInventoryButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewInventoryButtonActionPerformed
        // TODO add your handling code here:
        new PharmaInventory(pharma_id,pharma_name).setVisible(true);
    ...
    private void pharmaPinFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pharmaPinFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_pharmaPinFieldActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PharmacyHomePage("admin", "").setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField pharmaAddressField;
    private javax.swing.JTextField pharmaContactField;
    private javax.swing.JTextField pharmaNameField;
    private javax.swing.JPasswordField pharmaPassField;
    private javax.swing.JTextField pharmaPinField;
